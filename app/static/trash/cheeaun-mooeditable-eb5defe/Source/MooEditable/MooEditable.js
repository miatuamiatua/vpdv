...
this.MooEditable = new Class({
	...
	options: {
		...
		xhtml : true,
		semantics : true,
		actions: 'bold italic underline strikethrough | insertunorderedlist insertorderedlist | undo redo | createlink unlink | urlimage | toggleview',
		handleSubmit: true,
		handleLabel: true,
		disabled: false,
...
MooEditable.Locale = {
	...
	define: function(key, value){
		if (typeOf(window.Locale) != 'null') return Locale.define('de-DE', 'MooEditable', key, value);
...
MooEditable.Locale.define({
	...
	undo: 'Отменить',
	redo: 'Вернуть',
	removeHyperlink: 'Убрать гиперссылку',
	addHyperlink: 'Добавить гиперссылку',
	selectTextHyperlink: 'Выберите текст для вставки гиперссылки',
	enterURL: 'Введите адрес',
	enterImageURL: 'Введите адрес картинки',
